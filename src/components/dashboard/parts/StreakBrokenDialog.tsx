  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} maxWidth="sm">
      <div className="flex flex-col items-center gap-3 text-center p-8">
        ...
        <div
          className={cn(
            "mt-1 rounded-[var(--ng-radius)] border px-3.5 py-2 text-[11px] font-black uppercase tracking-[0.08em]",
            canFreezeNow
              ? "border-[rgba(44,200,255,0.30)] bg-[rgba(44,200,255,0.10)] text-[#7DD3FC]"
