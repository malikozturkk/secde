...
function ColorSwatch({ color, isSelected, onClick }: ColorSwatchProps) {
  return (
    <button
      ...
      onClick={onClick}
      title={color}
      className="relative w-full max-w-28 h-28 rounded-xl border-2 transition-all duration-150 flex items-center justify-center cursor-pointer hover:scale-110 active:scale-95"
      style={{
