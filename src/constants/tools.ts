...
export const TOOLS: readonly ToolMeta[] = [
  {
    ...
    surface: "bg-gradient-to-b from-[rgba(37,180,154,0.12)] to-[#1C2E35] to-60%",
  ...
  },
  {
    ...
    surface: "bg-gradient-to-b from-[rgba(176,123,74,0.13)] to-[#1C2E35] to-60%",
    accent: "#E0B487",
  },
  {
    id: ToolId.Zakat,
    ...
    description: "Varlığını gir, nisabı aşıyor musun ve ne kadar zekât düşüyor gör.",
    eyebrow: "HESAP",
    nodeBg: "bg-gradient-to-b from-[#FFCA6B] to-[#D98A0B]",
    nodeShadow: "shadow-[0_6px_0_0_#7A5A0D]",
    ring: "border-[rgba(245,166,35,0.40)]",
    surface: "bg-gradient-to-b from-[rgba(245,166,35,0.12)] to-[#1C2E35] to-60%",
...
export const KAABA_COORDINATES = { latitude: 21.4224779, longitude: 39.8251832 } as const;
...
export const DHIKR_PRESETS: readonly DhikrPreset[] = [
  { id: "subhanallah", label: "Sübhânallah", meaning: "Allah her türlü eksiklikten uzaktır", target: 33 },
  { id: "elhamdulillah", label: "Elhamdülillah", meaning: "Hamd Allah'a mahsustur", target: 33 },
  { id: "allahuekber", label: "Allâhu ekber", meaning: "Allah en büyüktür", target: 33 },
  { id: "tevhid", label: "Lâ ilâhe illallah", meaning: "Allah'tan başka ilah yoktur", target: 100 },
  { id: "istigfar", label: "Estağfirullah", meaning: "Allah'tan bağışlanma dilerim", target: 100 },
  { id: "salavat", label: "Allâhümme salli alâ Muhammed", meaning: "Peygamber'e salât ve selam", target: 100 },
] as const;
