      ...
      <div className="w-full max-w-[500px] bg-[#1a2b30] border-2 border-white/5 rounded-[32px] p-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="space-y-6 relative z-10">
          <div className="flex flex-wrap gap-3">
            {isNamaz && step.rekat && (
              <div className="bg-white/5 px-4 py-2 rounded-xl flex items-center gap-2 border border-white/5 shadow-sm">
                <span className="text-[11px] font-black uppercase text-white/30 tracking-widest">
                  Rekat
                </span>
          ...
          {step.recitation && (
            ...
            >
              <div className="text-[12px] font-black uppercase text-white/30 mb-3 tracking-widest">
                Okunuş
              </div>
          ...
          {step.tips && step.tips.length > 0 && (
            <div className="pt-2">
              <div className="flex items-center gap-2 mb-3">
                ...
                <span className="text-[13px] font-black uppercase text-white/30 tracking-widest">
                  İpuçları
                </span>
              </div>
              <ul className="m-0 p-0 list-none space-y-2">
                {step.tips.map((tip, idx) => (
                  <li
                    key={idx}
                    className="flex gap-2 text-[14px] font-bold text-white/50 leading-snug"
                  >
