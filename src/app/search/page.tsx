    ...
    <AppLayout
      rightPanel={
        <div className="w-full flex flex-col gap-4">
          <div className="ng-animate-ske rounded-[var(--ng-radius)] h-[200px] w-full border-2 border-white/10" />
          <div className="ng-animate-ske rounded-[var(--ng-radius)] h-[140px] w-full border-2 border-white/10" />
        </div>
      }
    >
      <style>{`
      ...
      <div className="max-w-xl mx-auto w-full flex flex-col gap-3">
        ...
        <div className="ng-animate-ske rounded-[var(--ng-radius)] h-[88px] w-full" />
        <div className="ng-animate-ske rounded-[var(--ng-radius)] h-[88px] w-full" />
      </div>
    </AppLayout>
  );
