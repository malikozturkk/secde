...
export default function AddFriendCard() {
  ...
  return (
    <>
      <div className="border-2 border-[rgba(255,255,255,0.15)] rounded-[var(--ng-radius)] flex flex-col overflow-hidden bg-[var(--ng-canvas)] shadow-[0_4px_16px_rgba(0,0,0,0.2)]">
